...
class RedisController:
    ...
    def _run_recording_timer(self) -> None:
        while not self._rec_timer_stop.is_set():
            ...
            # phantom-timer watchdog: rec was pulsed but the camera never engaged
            if elapsed > 3.0 and str(self.get_value(ParameterKey.IS_RECORDING.value, "0")) != "1" and str(self.get_value(ParameterKey.REC.value, "0")) != "1":
                break
