...
The local camera includes a calibrated LEVEL and SHAKE HUD.

LEVEL uses the ICM-42688 accelerometer after physical calibration and camera-frame alignment. SHAKE is not total angular velocity: it is the higher-frequency residual remaining after smooth camera motion is removed from the calibrated gyro signal.
